...
class _WorkspaceApiUrl {
  static Map<String, String> urls = {
    ...
    'BULK_CREATE_PROFILE_FIELD':
        'pigeonholes/:pigeonholeId/profile-fields/bulk',
    'DELETE_PROFILE_FIELD':
        'pigeonholes/:pigeonholeId/profile-fields/:fieldName',
    ...
    'UPDATE_REGISTRANT':
        'pigeonholes/:pigeonholeId/registrants/:registrantId/update',
    ...
    'LIST_NESTED_SESSION':
        'pigeonholes/:pigeonholeId/sessions/:sessionId/relationships/sessions',
    'NEST_SESSION':
        'pigeonholes/:pigeonholeId/sessions/:sessionId/relationships/sessions',
    'REPLACE_NEST_SESSION':
        'pigeonholes/:pigeonholeId/sessions/:sessionId/relationships/sessions',
    'LIST_SPEAKER_IN_SESSION':
        'pigeonholes/:pigeonholeId/sessions/:sessionId/relationships/speakers',
    'ADD_SPEAKER_IN_SESSION':
        'pigeonholes/:pigeonholeId/sessions/:sessionId/relationships/speakers',
    'REPLACE_SPEAKER_IN_SESSION':
        'pigeonholes/:pigeonholeId/sessions/:sessionId/relationships/speakers',
    'GENERATE_ONE_TIME_LINK':
        'pigeonholes/:pigeonholeId/sessions/:sessionId/one-time-links/generate',
    'DELETE_ONE_TIME_LINK':
        'pigeonholes/:pigeonholeId/sessions/:sessionId/one-time-links/:token',
    'LIST_ONE_TIME_LINK':
        'pigeonholes/:pigeonholeId/sessions/:sessionId/one-time-links',
...
class _OAuthApiUrl {
  static Map<String, String> urls = {
    'LIST_ATTENDEE':
        'workspaces/:workspaceId/pigeonholes/:pigeonholeId/attendees',
    'BULK_UPDATE_ATTENDEE':
        'workspaces/:workspaceId/pigeonholes/:pigeonholeId/attendees/bulk',
    'LIST_PROFILE_FIELD':
        'workspaces/:workspaceId/pigeonholes/:pigeonholeId/profile-fields',
    'CREATE_PROFILE_FIELD':
        'workspaces/:workspaceId/pigeonholes/:pigeonholeId/profile-fields',
    'BULK_CREATE_PROFILE_FIELD':
        'workspaces/:workspaceId/pigeonholes/:pigeonholeId/profile-fields/bulk',
    'DELETE_PROFILE_FIELD':
        'workspaces/:workspaceId/pigeonholes/:pigeonholeId/profile-fields/:fieldName',
    ...
    'UPDATE_PIGEONHOLE':
        'workspaces/:workspaceId/pigeonholes/:pigeonholeId/update',
    'LIST_REGISTRANT':
        'workspaces/:workspaceId/pigeonholes/:pigeonholeId/registrants',
    'CREATE_REGISTRANT':
        'workspaces/:workspaceId/pigeonholes/:pigeonholeId/registrants',
    'UPDATE_REGISTRANT':
        'workspaces/:workspaceId/pigeonholes/:pigeonholeId/registrants/:registrantId/update',
    'DELETE_REGISTRANT':
        'workspaces/:workspaceId/pigeonholes/:pigeonholeId/registrants/:registrantId',
    'BULK_UPDATE_REGISTRANT':
        'workspaces/:workspaceId/pigeonholes/:pigeonholeId/registrants/bulk',
    'LIST_SESSION':
        'workspaces/:workspaceId/pigeonholes/:pigeonholeId/sessions',
    'CREATE_SESSION':
        'workspaces/:workspaceId/pigeonholes/:pigeonholeId/sessions',
    'INSPECT_SESSION':
        'workspaces/:workspaceId/pigeonholes/:pigeonholeId/sessions/:sessionId',
    'UPDATE_SESSION':
        'workspaces/:workspaceId/pigeonholes/:pigeonholeId/sessions/:sessionId/update',
    'START_A_SESSION':
        'workspaces/:workspaceId/pigeonholes/:pigeonholeId/sessions/:sessionId/start',
    'LIST_NESTED_SESSION':
        'workspaces/:workspaceId/pigeonholes/:pigeonholeId/sessions/:sessionId/relationships/sessions',
    'NEST_SESSION':
        'workspaces/:workspaceId/pigeonholes/:pigeonholeId/sessions/:sessionId/relationships/sessions',
    'REPLACE_NEST_SESSION':
        'workspaces/:workspaceId/pigeonholes/:pigeonholeId/sessions/:sessionId/relationships/sessions',
    'LIST_SPEAKER_IN_SESSION':
        'workspaces/:workspaceId/pigeonholes/:pigeonholeId/sessions/:sessionId/relationships/speakers',
    'ADD_SPEAKER_IN_SESSION':
        'workspaces/:workspaceId/pigeonholes/:pigeonholeId/sessions/:sessionId/relationships/speakers',
    'REPLACE_SPEAKER_IN_SESSION':
        'workspaces/:workspaceId/pigeonholes/:pigeonholeId/sessions/:sessionId/relationships/speakers',
    'GENERATE_ONE_TIME_LINK':
        'workspaces/:workspaceId/pigeonholes/:pigeonholeId/sessions/:sessionId/one-time-links/generate',
    'DELETE_ONE_TIME_LINK':
        'workspaces/:workspaceId/pigeonholes/:pigeonholeId/sessions/:sessionId/one-time-links/:token',
    'LIST_ONE_TIME_LINK':
        'workspaces/:workspaceId/pigeonholes/:pigeonholeId/sessions/:sessionId/one-time-links',
    'GET_INSIGHT':
        'workspaces/:workspaceId/pigeonholes/:pigeonholeId/sessions/:sessionId/insights',
    'LIST_SPEAKER':
        'workspaces/:workspaceId/pigeonholes/:pigeonholeId/speakers',
    'CREATE_SPEAKER':
        'workspaces/:workspaceId/pigeonholes/:pigeonholeId/speakers',
    'UPDATE_SPEAKER':
        'workspaces/:workspaceId/pigeonholes/:pigeonholeId/speakers/:speakerId/update',
